        ...
        <div className="max-w-5xl" style={{ width: '100%' }}>
          ...
          <Stagger style={{ display: 'flex', flexWrap: 'wrap', gap: '24px', justifyContent: 'center' }} amount={0.1} gap={0.12}>
            {[
              ...
              <div style={{ position: 'relative', padding: '32px 24px', background: 'rgba(255,255,255,0.05)', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.1)', backdropFilter: 'blur(10px)', transition: 'all 0.3s ease', height: '100%' }}
                onMouseEnter={(e) => {
        ...
        <div className="max-w-5xl" style={{ width: '100%' }}>
          ...
          <Stagger style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '32px', marginBottom: '48px' }} amount={0.1} gap={0.12}>
            {[
              ...
              <StaggerItem key={idx}>
              <div style={{ padding: '40px 32px', backgroundColor: '#ffffff', borderRadius: '16px', border: '2px solid rgba(255, 20, 147, 0.15)', boxShadow: '0 4px 12px rgba(0,0,0,0.05)', transition: 'all 0.3s ease', textAlign: 'center' }}
                onMouseEnter={(e) => {
                  e.currentTarget.style.transform = 'translateY(-8px)';
                  e.currentTarget.style.boxShadow = '0 12px 32px rgba(255,20,147,0.15)';
