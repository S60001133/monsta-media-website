...
/**
 * Monsta Media footer — WHITE background (brand accent), dark text,
 * hot-pink (#E9178C) accents. All links/content identical to before.
 */
export default function Footer() {
  ...
  const handleNavigation = (path: string) => {
    ...
    // Handle hash anchors for smooth scrolling (via Lenis when active)
    ...
    <>
        ...
        style={
          {
            ...
            position: 'relative',
            background: '#FFFFFF',
            // flip the dark-theme tokens to dark-on-white for the footer scope
            '--ink': '#1C1812',
      ...
      >
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          <div className="grid grid-cols-1 md:grid-cols-5 gap-12 mb-8 text-center md:text-left">
            ...
            <div className="space-y-2 flex flex-col items-center md:items-start">
              <img
                ...
                loading="lazy"
              />
              <p className="text-sm leading-snug max-w-xs" style={{ marginLeft: '8px', color: 'var(--ink-2)' }}>
              ...
              <div className="flex gap-6 justify-center md:justify-start" style={{ marginLeft: '12px', marginTop: '24px' }}>
                ...
                <a
                  ...
                  aria-label="Facebook"
                >
                  <svg className="w-10 h-10" fill="#E9178C" viewBox="0 0 24 24">
            ...
            <div className="md:col-span-1 flex flex-col items-center md:items-start">
              <h3 className="footer-heading mb-4 text-center md:text-left">Services</h3>
              ...
              <ul className="space-y-2 text-sm" style={{ color: 'var(--ink-2)' }}>
                ...
                <li className="pt-2">
                  <button
                    ...
                    style={{ color: '#E9178C', background: 'none', border: 'none', padding: 0, font: 'inherit' }}
                  >
                    Book a Free Call →
                  </button>
                </li>
          ...
          {/* Bottom Bar */}
          <div style={{ marginTop: '60px', borderColor: 'rgba(233,23,140,0.15)' }} className="pt-8 border-t flex flex-col md:flex-row justify-center items-center gap-2 md:gap-4 text-sm text-center">
            <p style={{ color: 'var(--ink-2)' }}>&copy; {year} Monsta Media Parramatta. All rights reserved.</p>
            <div className="hidden md:block w-px h-5" style={{ background: 'var(--hairline)' }} aria-hidden="true"></div>
            <div className="block md:hidden h-px w-12" style={{ background: 'var(--hairline)' }} aria-hidden="true"></div>
            <button type="button" onClick={() => handleNavigation('/privacy')} className="footer-link cursor-pointer" style={{ background: 'none', border: 'none', padding: 0, font: 'inherit' }}>Privacy Policy</button>
          </div>
        </div>
      </footer>
    </>
