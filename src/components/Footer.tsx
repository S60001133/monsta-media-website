...
export default function Footer() {
  ...
  return (
    <>
      ...
      `}</style>
      <footer className="bg-[#030305] border-t text-white relative z-50" style={{ borderColor: 'rgba(255,20,147,0.2)', paddingTop: '20px', paddingBottom: '0px', position: 'relative' }}>
        {/* Neon top divider */}
        <div className="neon-divider" style={{ position: 'absolute', top: 0, left: '8%', right: '8%' }} />
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-12 mb-8 text-center md:text-left">
            ...
            <div className="space-y-2 flex flex-col items-center md:items-start">
              <img 
                ...
                loading="lazy"
              />
              <p className="text-white/60 text-sm leading-snug max-w-xs" style={{ marginLeft: '8px' }}>
              ...
              <div className="flex gap-6 justify-center md:justify-start" style={{ marginLeft: '12px', marginTop: '24px' }}>
                ...
                <a 
                  ...
                  aria-label="Facebook"
                >
                  <svg className="w-10 h-10" fill="#ff1493" viewBox="0 0 24 24" style={{ filter: 'drop-shadow(0 0 8px rgba(255,20,147,0.5))' }}>
              ...
              <ul className="space-y-2 text-sm text-white/60">
                ...
                <li className="pt-2">
                  <a 
                    ...
                    style={{ color: '#ff1493', textShadow: '0 0 10px rgba(255,20,147,0.5)' }}
                  >
                    Book a Free Call →
                  </a>
                </li>
          ...
          {/* Bottom Bar */}
          <div style={{ marginTop: '60px', borderColor: 'rgba(255,20,147,0.15)' }} className="pt-8 border-t flex flex-col md:flex-row justify-center items-center gap-2 md:gap-4 text-sm text-center">
            <p className="text-white/60">&copy; {year} Monsta Media Parramatta. All rights reserved.</p>
            <div className="hidden md:block w-px h-5 bg-white/20" aria-hidden="true"></div>
            <div className="block md:hidden h-px w-12 bg-white/20" aria-hidden="true"></div>
